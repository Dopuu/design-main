    ...
    return (
        <div className='flex flex-col h-full'>
            <div className='flex w-full k align-middle'>
                <h1 className='text-[30px] text-black font-inder font-semibold flex-1 inline-block self-center'>Nepreberaci</h1>
                <h1 className='text-[14x] desktop3:mr-[104px] desktop10:mr-[0px] text-gray-400 font-inder inline-block self-center'>Zobrazit viacej</h1>
            </div>
            <div class="table w-full border-spacing-y-4 h-full overflow-y-scroll overflow-hidden">
                <div class="table-row-group w-full h-full overflow-y-scroll overflow-hidden absolute scrollbar-thin scrollbar-thumb-gray-900 scrollbar-track-gray-100">
                    ...
                    <div className="table-row h-8">
                        ...
                        <div className="table-cell align-middle pl-20 font-inriasans text-gray-500 desktop10:hidden">23/09/22</div>
                        <div className="table-cell align-middle pl-16 font-semibold">Facebook</div>
                        <div className="table-cell align-middle pl-[93px] cursor-pointer"><BsThreeDotsVertical /></div>
                    </div>
                </div>
            </div>
        </div>
